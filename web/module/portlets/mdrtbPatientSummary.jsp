			...
			<tbody>
				<c:forEach var="patient" items="${model.data}">
					...
					<tr>
						...
						<td colspan="2"><span class="mdrListLabel">Crachat Initiale:</span><br/><span class="mdrListValue">${patient.initialSmear} <c:if test="${!empty patient.initialSmearDate}">(<openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.initialSmearDate}"/>)</c:if></span></td>
					...
					<tr>
						...
						<td colspan="2"><span class="mdrListLabel">Culture Initiale:</span><br/><span class="mdrListValue">${patient.initialCulture} <c:if test="${!empty patient.initialCultureDate}">(<openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.initialCultureDate}"/>)</c:if></span></td>
					...
					<tr>
						...
						<td colspan="2"><span class="mdrListLabel">Derniere X-Ray:</span><br/><span class="mdrListValue">${patient.xRayLast} <c:if test="${!empty patient.xRayLastDate}">(<openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.xRayLastDate}"/>)</c:if></span></td>
					</tr>
					<tr>
						<td colspan="2">
						...
						<td colspan="4"><span class="mdrListLabel">Profil de Resistance/DST:</span><br/><span class="mdrListValue"><openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.dstResultParentDate}"/> ${patient.resistanceList} </span></td>
						<td colspan="2"><span class="mdrListLabel">Derniere AFB:</span><br/><span class="mdrListValue">${patient.smearLast} <c:if test="${!empty patient.smearLastDate}">(<openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.smearLastDate}"/>)</c:if></span></td>
					</tr>
					<tr>
						...
						<td colspan="2"><span class="mdrListLabel">Derniere Culture:</span><br/><span class="mdrListValue">${patient.cultureLast} <c:if test="${!empty patient.cultureLastDate}">(<openmrs:formatDate format="${_dateFormatDisplay}" date="${patient.cultureLastDate}"/>)</c:if></span></td>
					</tr>
					<tr>
