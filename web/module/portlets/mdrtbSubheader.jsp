...
<td align="left">
	<ul id="menu">	
		...
		<a href="${pageContext.request.contextPath}/module/mdrtb/dashboard/dashboard.form?patientId=${model.patient.patientId}"><spring:message code="mdrtb.overview" text="Overview"/></a></li>
		
		
		<li <c:if test='<%= request.getRequestURI().contains("chart") %>'>class="active"</c:if>>
		<a href="${pageContext.request.contextPath}/module/mdrtb/chart/chart.form?patientId=${model.patient.patientId}"><spring:message code="mdrtb.chart" text="Chart"/></a></li>
	...
	<!-- 	
		...
		<a href="${pageContext.request.contextPath}/module/mdrtb/regimen/regimen.form?patientId=${model.patient.patientId}"><spring:message code="mdrtb.regimens" text="Regimens"/></a></li>
	
		
		<li <c:if test='<%= request.getRequestURI().contains("specimen") %>'>class="active"</c:if>>
		<a href="${pageContext.request.contextPath}/module/mdrtb/specimen/list.form?patientId=${model.patient.patientId}"><spring:message code="mdrtb.labResults" text="Lab Results"/></a></li>
