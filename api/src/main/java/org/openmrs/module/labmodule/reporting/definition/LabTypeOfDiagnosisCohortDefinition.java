...
@Localized("mdrtb.reporting.TypeOfDiagnosisCohortDefinition")
public class LabTypeOfDiagnosisCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public LabTypeOfDiagnosisCohortDefinition() {
		super();
	}
