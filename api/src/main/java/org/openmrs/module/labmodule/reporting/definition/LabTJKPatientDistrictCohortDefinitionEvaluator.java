 ...
 */
@Handler(supports = { LabTJKPatientDistrictCohortDefinition.class })
public class LabTJKPatientDistrictCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	
	/**
	 * Default Constructor
	 */
	public LabTJKPatientDistrictCohortDefinitionEvaluator() {
	}
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
		...
		LabTJKPatientDistrictCohortDefinition cd = (LabTJKPatientDistrictCohortDefinition) cohortDefinition;
