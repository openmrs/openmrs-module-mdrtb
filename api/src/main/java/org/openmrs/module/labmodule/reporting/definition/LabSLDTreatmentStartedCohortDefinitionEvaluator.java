...
/**
 * Evaluates an SLDTreatmentStartedCohortDefinition and produces a Cohort
 */
@Handler(supports={LabSLDTreatmentStartedCohortDefinition.class})
public class LabSLDTreatmentStartedCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public LabSLDTreatmentStartedCohortDefinitionEvaluator() {}
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {	
    	LabSLDTreatmentStartedCohortDefinition cd = (LabSLDTreatmentStartedCohortDefinition) cohortDefinition;
