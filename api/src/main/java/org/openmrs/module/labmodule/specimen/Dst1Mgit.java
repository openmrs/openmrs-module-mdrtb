...
public class Dst1Mgit implements Comparable<Dst1Mgit> {
	...
	public void setResistanceLfx(Concept resistanceLfx) {
		System.out.println("setting ResistanceLfx: "+ resistanceLfx.getDisplayString());
	...
	public void setResistanceZ(Concept resistanceZ) {
		System.out.println("setting ResistanceZ: "+ resistanceZ.getDisplayString());
	...
	public int compareTo(Dst1Mgit dm) {
