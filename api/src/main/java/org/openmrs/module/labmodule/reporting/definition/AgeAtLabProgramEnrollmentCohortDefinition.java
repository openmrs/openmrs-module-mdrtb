...
@Localized("dotsreports.reporting.AgeAtMdrtbProgramEnrollmentCohortDefinition")
public class AgeAtLabProgramEnrollmentCohortDefinition extends ProgramEnrollmentCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public AgeAtLabProgramEnrollmentCohortDefinition() {
		super();
	}
