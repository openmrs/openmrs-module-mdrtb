...
/**
 * Evaluates an FLDTreatmentStartedCohortDefinition and produces a Cohort
 */
@Handler(supports={LabFLDTreatmentStartedCohortDefinition.class})
public class LabFLDTreatmentStartedCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public LabFLDTreatmentStartedCohortDefinitionEvaluator() {}
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {	
    	LabFLDTreatmentStartedCohortDefinition cd = (LabFLDTreatmentStartedCohortDefinition) cohortDefinition;
