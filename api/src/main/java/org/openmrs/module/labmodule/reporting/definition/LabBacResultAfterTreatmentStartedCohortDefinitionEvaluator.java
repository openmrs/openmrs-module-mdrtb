 ...
 */
@Handler(supports={LabBacResultAfterTreatmentStartedCohortDefinition.class},order=20)
public class LabBacResultAfterTreatmentStartedCohortDefinitionEvaluator extends LabTreatmentStartedCohortDefinitionEvaluator {
	
	/**
	 * Default Constructor
	 */
	public LabBacResultAfterTreatmentStartedCohortDefinitionEvaluator() {}
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
    	...
    	LabBacResultAfterTreatmentStartedCohortDefinition cd = (LabBacResultAfterTreatmentStartedCohortDefinition) cohortDefinition;
