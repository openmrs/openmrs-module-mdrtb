...
public class CompletedLabProgramEnrolledDuringTJKCohortDefinition extends ProgramEnrollmentCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public CompletedLabProgramEnrolledDuringTJKCohortDefinition() {
		super();
	}
