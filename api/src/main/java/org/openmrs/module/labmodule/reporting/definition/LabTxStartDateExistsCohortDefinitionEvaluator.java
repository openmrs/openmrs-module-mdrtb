 ...
 */
@Handler(supports = { LabTxStartDateExistsCohortDefinition.class })
public class LabTxStartDateExistsCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	
	/**
	 * Default Constructor
	 */
	public LabTxStartDateExistsCohortDefinitionEvaluator() {
	}
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
		...
		LabTxStartDateExistsCohortDefinition cd = (LabTxStartDateExistsCohortDefinition) cohortDefinition;
		//Cohort c = null;
		
		Cohort c = MdrtbQueryService.getPatientsWithDOTSTxStartDate(context, cd.getMinResultDate(), cd.getMaxResultDate());
