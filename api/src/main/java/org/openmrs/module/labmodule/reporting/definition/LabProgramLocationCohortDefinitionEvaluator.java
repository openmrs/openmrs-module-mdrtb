 ...
 */
@Handler(supports={LabProgramLocationCohortDefinition.class})
public class LabProgramLocationCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public LabProgramLocationCohortDefinitionEvaluator() {}
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
      	...
      	LabProgramLocationCohortDefinition cd = (LabProgramLocationCohortDefinition) cohortDefinition;
