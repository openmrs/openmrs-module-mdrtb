...
@Localized("dotsreports.reporting.DotsPatientProgramStateCohortDefinition")
public class LabPatientProgramStateCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public LabPatientProgramStateCohortDefinition() {
		super();
	}
