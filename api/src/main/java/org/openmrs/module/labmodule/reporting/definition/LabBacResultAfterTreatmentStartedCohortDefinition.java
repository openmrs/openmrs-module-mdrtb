...
@Localized("dotsreports.reporting.DotsBacResultAfterTreatmentStartedCohortDefinition")
public class LabBacResultAfterTreatmentStartedCohortDefinition extends LabTreatmentStartedCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public LabBacResultAfterTreatmentStartedCohortDefinition() {
		super();
	}
