...
@Localized("dotsreports.reporting.FLDTreatmentStartedCohortDefinition")
public class LabFLDTreatmentStartedCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public LabFLDTreatmentStartedCohortDefinition() {
		super();
