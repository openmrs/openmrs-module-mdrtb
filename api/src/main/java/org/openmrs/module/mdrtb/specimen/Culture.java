...
public interface Culture extends Bacteriology {
	 ...
	 * the Concept that represents the method used when performing the test organism: the type of
	 * organism present daysToPosiivity: the number of days for a culture to show a positive result
	 */
