...
public abstract class TestImpl implements Test {
	...
	public void setDateOrdered(Date dateOrdered) {
		...
		if (obs == null) {
			...
			obs = new Obs(test.getPerson(),
					Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.TEST_DATE_ORDERED),
	...
	public void setDateReceived(Date dateReceived) {
		...
		if (obs == null) {
			obs = new Obs(test.getPerson(),
					Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.TEST_DATE_RECEIVED),
					test.getObsDatetime(), test.getLocation());
			obs.setEncounter(test.getEncounter());
			test.addGroupMember(obs);
		}
	...
	public void setStartDate(Date startDate) {
		...
		if (obs == null) {
			obs = new Obs(test.getPerson(),
					Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.TEST_START_DATE),
					test.getObsDatetime(), test.getLocation());
			obs.setEncounter(test.getEncounter());
			test.addGroupMember(obs);
		}
	...
	/**
	 * Determines the current status of this test by examines the values of the
	 * various date fields Auto generated method comment
	 * 
	 * @return
	 */
