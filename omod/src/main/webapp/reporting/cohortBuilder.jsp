...
<!-- THIS IS A STRAIGHT COPY OF COHORT BUILDER FROM REPORTING COMPATIBILITY AS OF 15/NOV/2010. 
	 THE PLAN SHOULD BE TO SWAP THIS OUT WITH A REPORTING MODULE ALTERNATIVE WHEN POSSIBLE -->
...
<div id="cohort_builder_preview" style='padding: 4px<c:if test="${model.searchHistory.size == 0}">; display: none"</c:if>'>
	...
	<div style="border: 1px gray solid; padding: 0.5em; margin: 0.5em">
		<openmrs:portlet url="cohort" parameters="linkUrl=module/mdrtb/dashboard/dashboard.form" />
	</div>
