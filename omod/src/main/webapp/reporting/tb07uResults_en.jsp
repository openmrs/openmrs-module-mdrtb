...
<html>
	...
	<body>
		...
		<div id="tb07u" style="font-size:smaller; width:980px;">
			...
			<table width="100%"><tr>
				<td width="10%">&nbsp;</td>
				<td width="50%" align="center" style="font-size:14px; font-weight:bold;">Quarterly report on DR TB cases detection and initiation of treatment</td>
				<td width="10%" align="right">TB-07y</td>
			</tr></table>
			<br/><br/>
			...
			<table width="100%" border="1">
				<tr>
					...
					Name of area:  #location#<br/>
					Name of coordinator:  ________________<br/>
					Signature: ___________________________
				</td>
				
				<td valign="top">Cases detected in quarter #quarter# of #year# (#startDate|dd/MMM/yyyy# - #endDate|dd/MMM/yyyy#)<br/>
					Date: #generationDate|dd/MMM/yyyy#</td>
				</tr>
			</table>
			</center>
			<br/>
			...
			<span style="font-weight:bold;">
				Table 1. Number of DR TB cases detected during the quarter: 
			</span>
			<span style="font-weight:bold;">
				<br/><br/>
				<center><table width="100%" border="1">
					<tr>
					    <td rowspan="2" align="center">Number of DR TB cases detected<br/> during the quarter: </td>
			...
			<span style="font-weight:bold;">
				Table 2. Number of DR TB cases, started treatment during the quarter 
			</span>
			<br/><br/>
			...
			<table border="1" cellpadding="5" width="100%">
				<tr align="center">
					...
					<td colspan="7">Registration Group</td>
					<td rowspan="3">Other</td>
					<td rowspan="3">Total</td>
				</tr>
				<tr align="center">
					<td rowspan="2">New</td>
					<td colspan="2">Relapse after<br/>treatment on<br/>regimen</td>
					<td colspan="2">Default after<br/>treatment on<br/>regimen</td>
					<td colspan="2">Failure after<br/>treatment on<br/>regimen</td>
				</tr>
				<tr align="center">
					<td>I</td> <!-- relapse -->
					<td>II</td> <!-- relapse -->
				...
				<tr>
				     <td rowspan=3">of them<br/>children</td>
				     <td>0-4</td>
			...
			<br/><br/>	
			<span style="font-weight:bold;">
				Table 3. Number of DR TB cases, started treatment during the quarter 
			</span>
			<br/><br/>
			<table border="1" cellpadding="5" width="100%">
				<tr align="center">
				...
				<tr>
				    <td colspan="11" align="center">RR/MDR-TB</td> 
				</tr>
				<tr>
				   <td colspan="2">Short Regimen</td>
				...
				<tr>
				    <td colspan="2">Standard Regimen</td>
				...
				<tr>
				    <td colspan="11" align="center">Pre-XDR/XDR TB</td> 
				</tr>
				<tr>
				   <td colspan="2">Individual Regimen</td>
				...
				<tr>
				    <td colspan="2">Total Pre-XDR/XDR TB</td>
