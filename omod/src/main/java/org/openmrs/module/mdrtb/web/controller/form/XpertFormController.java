...
public class XpertFormController {
	...
	public ModelAndView processXpertForm (@ModelAttribute("xpert") XpertForm xpert, BindingResult errors, 
		...
		if(xpert.getMtbResult()!=null && xpert.getMtbResult().getId().intValue()!=Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.MTB_POSITIVE).getId().intValue()) {
