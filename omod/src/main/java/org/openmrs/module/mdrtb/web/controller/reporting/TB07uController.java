...
public class TB07uController {
	...
	private static RegimenForm getLatestRegimenForPatient(int patientId, ArrayList<RegimenForm> forms,
	        ArrayList<Location> locList, Integer year, String quarter, String month) {
