...
@Controller
@RequestMapping("/module/labmodule/lab/addPerson.form")
public class AddPersonController extends SimpleFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	private final String PATIENT_SHORT_EDIT_URL = "/module/labmodule/lab/newPatient.form";
	
	private final String LAB_ENTRY_URL = "/module/labmodule/lab/labEntry.form";
