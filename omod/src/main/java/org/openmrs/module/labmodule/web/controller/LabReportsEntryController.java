...
public class LabReportsEntryController {
    ...
    @RequestMapping("/module/labmodule/lab/labEntry")
    public void listPatients(ModelMap model,
	    			...
	    			@RequestParam(required=false, value="district") 		District district,
	    			@RequestParam(required=false, value="oblast") 			Region oblast,
	    			@RequestParam(required=false, value="facility") 		Facility facility,
    	...
    	List<Facility> facilities = Context.getService(MdrtbService.class).getFacilities();
    	List<District> districts = Context.getService(MdrtbService.class).getDistricts();
